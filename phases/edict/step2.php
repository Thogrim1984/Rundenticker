...
<div>
    <form>
        <label for="step_2_2_claimHex">Wie viele Hexfelder wurden eingenommen?</label>
        <input id="step_2_2_claimHex" type="number" min="0" value="0"> <br>
        <label for="step_2_2_abandonHex">Wie viele Hexfelder ohne Siedlungen wurden aufgegeben</label>
        <input id="step_2_2_abandonHex" type="number" min="0" value="0"> <br>
        <label for="step_2_2_abandonSettlement">Wie viele Hexfelder mit Siedlungen wurden aufgegeben</label>
        <input id="step_2_2_abandonSettlement" type="number" min="0" value="0"> <br>
